...
router.get('/', async (req, res) => {
  try {
    ...
    const sqlString = 'SELECT * FROM Hoadon inner join nhacungcap on hoadon.mancc = nhacungcap.mancc inner join nhanvien on hoadon.manv = nhanvien.manv';
    ...
    if (result.recordset.length === 0) {
      return res.render('Hoadon/index', {
